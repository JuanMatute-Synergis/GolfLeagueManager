-- Delete and Import Week 11 Matchups Script for PostgreSQL
...
BEGIN
    ...
    SELECT "Id" INTO season_id FROM "Seasons" WHERE "Name" LIKE '%2025%' OR "IsCurrent" = true LIMIT 1;
    ...
    IF week_id IS NULL THEN
        RAISE EXCEPTION 'Could not find Week 11 for the current season';
    END IF;
